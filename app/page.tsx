...
// The two outbound links on the page: the flagship personal-care brand's own
// site, from the panel in #impact, and the founder's LinkedIn from #leadership.
const PESHAGI_URL = "https://peshagi.com";
const FOUNDER_LINKEDIN = "https://www.linkedin.com/in/rrahuldalmia/";
      ...
      <section className="beat container" id="leadership">
        ...
        <div className="beat__body">
          <div className="founder plx">
            ...
            {/* The claim above is a career, and a career is the one thing a
                reader can check for themselves — so it links out to where the
                record actually is rather than asking to be taken on trust. */}
